...
class Project_Model extends CI_Model
{
	...
	{
		$this->db->select('a.project_id,a.project_title,a.project_category,a.created_date,a.short_description,a.cover_image,a.media_type,a.project_media,a.project_description,b.category_name');
		$this->db->from('tbl_mst_projects as a');
		$this->db->join('tbl_mst_project_categories as b','a.project_category=b.category_id','inner');
	...
	function getProjectsListByFund( $user_id )
    {
        ...
        $this->db->select("mbp.project_id, mbp.project_title, IF(sum(b.price) ,sum(b.price), 0) as amount, b.created_date");
