					...
					<div class="col-sm-4">
						<div class="c-body">
							...
							<div class="c-section">
								...
								<p>
									Physical Address: 2nd Floor, West Tower<br/>
...
Gauteng
							...
							<div class="c-section">
								...
								<p>
									<strong>TELL:</strong> +27 11 783 4913<br/><strong>CELL:</strong> +27 79 718 1843 <br/><strong>FAX:</strong> 086 604 5081
								</p>
							</div>
							<div class="c-section">
								<div class="c-content-label c-font-uppercase c-font-bold c-theme-bg">
		...
		<div id="gmapbg" class="c-content-contact-1-gmap" style="height: 663px;"></div>
	</div>
	<!-- END: CONTENT/CONTACT/CONTACT-1 -->
	<!-- BEGIN: CONTENT/CONTACT/FEEDBACK-2 -->
	<div class="c-content-box c-size-md c-no-padding c-bg-img-center" style="background-image:url(<?php echo frontend_asset_url()?>assets/base/img/content/backgrounds/bg_feedback_1.jpg);">
		<div class="container">
			<div class="c-content-feedback-1 c-option-2">
				<div class="c-content-title-1">
					<h3 class="c-center c-font-white c-font-bold c-font-uppercase"> <span style="margin-left: 132px;">SASS</span> <span class="c-font-black">CONSULTANTS</span></h3>
					<div class="c-line-center c-left">
					</div>
					<div class="c-line-center c-right">
					</div>
					<!--p class="c-center c-font-white">
						Modern Design&nbsp;<span>&nbsp;&nbsp;Always Connected</span>
					</p-->
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="c-container c-bg-white c-bg-img-bottom-right" style="background-image:url(<?php echo frontend_asset_url()?>assets/base/img/content/misc/feedback_box_3.png)">
							<div class="c-content-title-1">
								...
								<a href="#" class="btn btn-md c-btn-border-2x c-btn-square c-theme-btn c-btn-uppercase c-btn-bold">Learn More</a>
							</div>
						</div>
						<div class="c-container c-bg-white c-bg-img-bottom-right" style="background-image:url(<?php echo frontend_asset_url()?>assets/base/img/content/misc/feedback_box_2.png)">
							<div class="c-content-title-1">
								...
								<p class="c-font-lowercase">
									Donec facilisis finibus pharetra. Praesent pharetra tempus quam, malesuada pretium mi pharetra quis.
								</p>
							</div>
						</div>
					</div>
