							...
							<div class="c-media">
								<div class="c-content-media-2-slider" data-slider="owl" data-single-item="true" data-auto-play="4000">
									<div class="owl-carousel owl-theme c-theme owl-single">
										<div class="item">
											<div class="c-content-media-2" style="background-image: url(<?php echo frontend_asset_url()?>assets/base/img/content/misc/latest-work-3.jpg); min-height: 460px;">
											</div>
										</div>
										<div class="item">
											<div class="c-content-media-2" style="background-image: url(<?php echo frontend_asset_url()?>assets/base/img/content/misc/latest-work-7.jpg); min-height: 460px;">
											</div>
										</div>
										<div class="item">
											<div class="c-content-media-2" style="background-image: url(<?php echo frontend_asset_url()?>assets/base/img/content/misc/9.jpg); min-height: 460px;">
											</div>
										</div>
									</div>
								</div>
