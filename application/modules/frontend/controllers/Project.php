...
//$this->template->set('categories', $categories);
    ...
    public function connectToProject() {
        ...
        $project_owner = $this->common_model->getRecords('tbl_mst_projects as p', 'p.project_title,p.project_id,(select username from tbl_users where id=p.user_id) as username,(select email from tbl_users where id=p.user_id) as project_owner_email', array('project_id' => $this->input->post('id')));
