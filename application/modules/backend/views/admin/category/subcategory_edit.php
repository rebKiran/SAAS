        ...
        <div class="row">
            ...
            <div class="col-md-10">
                ...
                <div class="box box-info">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal" name='frm_add_category'  id='frm_add_subcategory' action="<?php echo base_url() ?>backend/subcategory-edit/<?php echo $edit_id;?>" method="POST">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-control" name="cat_id">
                                        ...
                                        {
                                            if($arr_subcategory_data['category_id']==$cat_data['category_id']){ $selected="selected";}
                                            else { $selected = "";}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" value="<?php echo $arr_subcategory_data['sub_category_name'];?>" name="sub_category_name" class="form-control" id="sub_category_name"  placeholder="Enter Subject">
                                </div>
                            </div>
