                         ...
                         <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="blog_category" required="required" class="form-control" autocomplete="off">
                                        ...
                                        <option <?php if ($post_info["blog_category"] == $category['category_id']) echo 'selected="selected"';?> value="<?php echo $category['category_id']?>"><?php echo $category['category_name']?></option>
                                        <?php }?>
                                    </select>
                            </div>
                        </div>
