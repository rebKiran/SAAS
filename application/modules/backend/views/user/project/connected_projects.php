                                    ...
                                    <table id="datatable-keytable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                           ...
                                           // if ($connected_projects != '') {
                                                foreach ($connected_projects as $connected_projects) {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $i; ?></td>
                                                        <td><?php echo $connected_projects['project_title']; ?></td>
                                                        <td><?php echo date('d F Y', strtotime($connected_projects['created_time'])); ?></td>
                                                        <td>
                                                            <a title="Edit Project" href="javascript:;" onclick="showchatmodal(<?php echo $connected_projects['project_owner_id'], "," . $connected_projects['project_id'] ?>)" class="btn btn-info btn-xs" ><i class="fa fa-comment"></i> Chat</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $i++;
